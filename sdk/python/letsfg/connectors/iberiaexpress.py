...
class IberiaExpressConnectorClient:
    ...
    async def _fetch_ancillaries(
        ...
        # Iberia Express Lite: no bag. Classic: 1×23 kg included.
        return {
            "bags_note": "Economy Lite (cheapest): no checked bag, first bag from EUR 25. Economy Classic/Flex: 1×23 kg included. Carry-on included.",
            "seat_note": "Seat selection: from EUR 10 (standard). Included on Classic/Flex fares.",
            "bags_from": None,
            "currency": currency,
        }
